    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/V1/api/sc/getBranches/**","/getBranches","/getBranches/**").permitAll()
                        ...
                        .requestMatchers("/V1/api/sc/getDashMessages/**","/getDashMessages","/getDashMessages/**").permitAll()
                        .requestMatchers("/V1/api/sc/getDashPhoneChats/**","/getDashPhoneChats","/getDashPhoneChats/**").permitAll()
                        .requestMatchers("/V1/api/sc/requestCloseChat/**","/requestCloseChat","/requestCloseChat/**").permitAll()
                        .requestMatchers("/V1/api/sc/editNotification/**","/editNotification","/editNotification/**").permitAll()
                        .requestMatchers("/V1/api/sc/getDashPhoneChatsArchived/**","/getDashPhoneChatsArchived","/getDashPhoneChatsArchived/**").permitAll()
                        .requestMatchers("/V1/api/sc/getStatisticsPhoneUsers/**","/getStatisticsPhoneUsers","/getStatisticsPhoneUsers/**").permitAll()
                        .requestMatchers("/V1/api/sc/createChat/**","/createChat","/createChat/**").permitAll()
                        .requestMatchers("/V1/api/sc/getStatisticsUses/**","/getStatisticsUses","/getStatisticsUses/**").permitAll()
                        .requestMatchers("/V1/api/sc/getFamilyBasicInformation/**","/getFamilyBasicInformation","/getFamilyBasicInformation/**").permitAll()
                        .requestMatchers("/V1/api/sc/deleteNotification/**","/deleteNotification","/deleteNotification/**").permitAll()
                        .requestMatchers("/V1/api/sc/loginEmployee/**","/loginEmployee","/loginEmployee/**").permitAll()
                        ...
                        .requestMatchers("/V1/api/sc/requestArchivedChat/**","/requestArchivedChat","/requestArchivedChat/**").permitAll()
                        .requestMatchers("/V1/api/sc/dashGetMessagesChat/**","/dashGetMessagesChat","/dashGetMessagesChat/**").permitAll()
                        .requestMatchers("/V1/api/sc/deleteAnnouncement/**","/deleteAnnouncement","/deleteAnnouncement/**").permitAll()
                        .requestMatchers("/V1/api/sc/dashPhotoChat/**","/dashPhotoChat","/dashPhotoChat/**").permitAll()
                        ...
                        .requestMatchers("/V1/api/sc/employeesDashboard/**","/employeesDashboard","/employeesDashboard/**").permitAll()
                        .requestMatchers("/V1/api/sc/allNewPhone/**","/allNewPhone","/allNewPhone/**").permitAll()
                        .requestMatchers("/V2/api/sc/SearchByNameV2/**","/SearchByNameV2","/SearchByNameV2/**").permitAll()
                        .requestMatchers("/V1/api/sc/checkNumber/**","/checkNumber","/checkNumber/**").permitAll()
                        .requestMatchers("/V1/api/sc/addHomePagePhoto/**","/addHomePagePhoto","/addHomePagePhoto/**").permitAll()
                        .requestMatchers("/V1/api/sc/viewHomePagePhotos/**","/viewHomePagePhotos","/viewHomePagePhotos/**").permitAll()
                        .requestMatchers("/V1/api/sc/newDashboardAccess/**","/newDashboardAccess","/newDashboardAccess/**").permitAll()
