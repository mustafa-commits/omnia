    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/V1/api/sc/loginUserDashboard/**","/loginUserDashboard","/loginUserDashboard/**").permitAll()
                        ...
                        .requestMatchers("/V1/api/sc/usersDashboard/**","/usersDashboard","/usersDashboard/**").permitAll()
                        ...
                        .requestMatchers("/V1/api/sc/newUserDashboard/**","/newUserDashboard","/newUserDashboard/**").permitAll()
