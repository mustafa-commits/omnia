...
public class LoginController {
    ...
    public AppUser login(@RequestBody long id) {
        return loginService.login(id);
    }

    @PostMapping("/V2/api/sc/loginById")
    public AppUser login2(@RequestParam long id) {
        return loginService.login(id);
    }

    @GetMapping("/V3/api/sc/loginById")
    public AppUser login3(@RequestParam long id) {
