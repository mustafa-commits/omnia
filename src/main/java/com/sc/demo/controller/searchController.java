...
import com.sc.demo.model.dto.search.SearchResponseV3;
...
public class searchController {
    ...
    // استعلام بأسم الوصي وجلب جميع معلومات الوصي
    @GetMapping("/V3/api/sc/SearchByNameV3")
    public List<SearchResponseV3> SearchByNameV3(@RequestParam String GuardianName){
        return searchService.SearchByNameV3(GuardianName);
    }
